...
app = FastAPI(title="Hurl Unmasks Recursive Literature Leaking Out Love", version="1.0.0")
...
async def health_check():
    ...
    return {"status": "healthy", "service": "hurl-unmasks-recursive-literature-leaking-out-love-backend"}
